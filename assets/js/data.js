...
const CURRICULUM = [
  ...
  },
  {
    ...
    topics: [
      ...
      { type: "B", title: "Shopify Native AI — Magic & Sidekick", detail: "Where Shopify's built-in AI (Magic content/image generation, Sidekick merchant assistant) ends and a custom Claude-powered agent begins." },
